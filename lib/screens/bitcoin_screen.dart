...
class _BitcoinScreenState extends State<BitcoinScreen> {
  ...
  Future<void> fetchCryptoData() async {
    final response =
        await http.get(Uri.parse('https://api.coinlore.net/api/ticker/?id=90'));
            ...
            cryptoData == null
                ...
                : Padding(
                    ...
                    child: ListView(
                      children: [
                        SizedBox(height: 180),
                        DetailItem(title: 'Name', value: cryptoData!['name']),
                        SizedBox(height: 100),
                        DetailItem(
                            title: 'Symbol', value: cryptoData!['symbol']),
                        SizedBox(height: 100),
                        DetailItem(
                            title: 'Rank', value: '${cryptoData!['rank']}'),
                        SizedBox(height: 100),
                        DetailItem(
                            title: 'Price (USD)',
                        ...
                        DetailItem(
                            title: '1h Change',
                            value: '${cryptoData!['percent_change_1h']}%'),
                        SizedBox(height: 100),
                        DetailItem(
                            title: '7d Change',
