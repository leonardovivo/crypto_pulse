...
class CardanoScreen extends StatefulWidget {
  @override
  _CardanoScreenState createState() => _CardanoScreenState();
}

class _CardanoScreenState extends State<CardanoScreen> {
  ...
  Future<void> fetchCryptoData() async {
    final response = await http
        .get(Uri.parse('https://api.coinlore.net/api/ticker/?id=257'));
