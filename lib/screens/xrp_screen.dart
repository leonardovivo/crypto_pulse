...
class XrpScreen extends StatefulWidget {
  @override
  _XrpScreenState createState() => _XrpScreenState();
}

class _XrpScreenState extends State<XrpScreen> {
  ...
  Future<void> fetchCryptoData() async {
    final response =
        await http.get(Uri.parse('https://api.coinlore.net/api/ticker/?id=58'));
