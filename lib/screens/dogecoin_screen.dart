...
class DogecoinScreen extends StatefulWidget {
  @override
  _DogecoinScreenState createState() => _DogecoinScreenState();
}

class _DogecoinScreenState extends State<DogecoinScreen> {
  ...
  Future<void> fetchCryptoData() async {
    final response = await http.get(Uri.parse('https://api.coinlore.net/api/ticker/?id=2'));
